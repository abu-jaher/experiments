                    ...
                    <div class="section-inner">
                        <div class="row row-centered">
                            <div class="partner_logo">
                                ...
                                <div class="logo-2"><div class="mktoImg mktoGen" id="mkto_gen_partner-logo-2"><img src="https://techhub.dice.com/rs/318-VQK-428/images/jd-logo_print-06.png" class="lpimg" id="partner-logo-2" mktoname="Partner-logo-2"></div></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-inner white">
                    <div class="row row-centered section-rule">
                        ...
                        <div id="resource-column-left" class="large-6 large-pull-6 columns">
                            <h2 class="heading-small">dice + jobdiva</h2>
                            ...
                            <div id="resource-description" class="mktoText">
                                <p style="line-height: 28px;"><span style="font-size: 20px;"><strong><span
                                    style="font-family: arial, helvetica, sans-serif;">Why Dice is a perfect complement to JobDiva</span></strong></span></p>
                                <ul>
                                ...
                                <p><span style="font-family: arial, helvetica, sans-serif;">As a JobDiva customer, we’re offering you access to Dice for two months, at no cost. We don’t believe in hidden fees – just take Dice’s powerful tech hiring tools for a test drive and let us know how it’s going!</span>
                                </p>
                                <p class="offer"><span
                                    style="color: #000000; font-family: arial, helvetica, sans-serif; font-size: 12px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: #ffffff; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;"><br>*This
                                        ...
                                        Dice agrees to authorize usage of the JobDiva API in connection with this offer provided that
                                        usage of the JobDiva API is limited to the previously referenced terms and conditions and the
                                        user understands and agrees no resumes, passwords or other information received as a result
                                        of the JobDiva API interface may be shared outside of the user’s organization.</span>
                                </p>
                            </div>
                        </div>
