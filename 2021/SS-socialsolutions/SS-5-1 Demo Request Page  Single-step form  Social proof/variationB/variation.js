    ...
    function init() {
      ...
      onLoadMktoForms2(function(){
        MktoForms2.whenReady(function (form) {
          ...
          document.querySelector("#FirstName") && document.querySelector("#FirstName").setAttribute("placeholder", "First Name");
          document.querySelector("#LastName") && document.querySelector("#LastName").setAttribute("placeholder", "Last Name");
          document.querySelector("#Email") && document.querySelector("#Email").setAttribute("placeholder", "Email Address");
          document.querySelector("#Phone") && document.querySelector("#Phone").setAttribute("placeholder", "Phone number");
          document.querySelector("#Company") && document.querySelector("#Company").setAttribute("placeholder", "Organization name");
          document.querySelector(".card-body .wp-block-ws-form") && document.querySelector(".card-body .wp-block-ws-form").insertAdjacentHTML("beforebegin", "<h2 class='fe-form-heading'>Get your free <br> personalized demo</h2>");
    
          document.querySelector("#industryType option") && (document.querySelector("#industryType option").innerHTML = "What type of organization are you?...")
          document.querySelector("#Division_1__c option") && (document.querySelector("#Division_1__c option").innerHTML = "What type of organization are you?...")
          document.querySelector("#numberofEmployeesstring option") && (document.querySelector("#numberofEmployeesstring option").innerHTML = "How many employees are in your organization?...")
          document.querySelector("#jobDepartment option") && (document.querySelector("#jobDepartment option").innerHTML = "Which best describes your department?...")
          document.querySelector("#jobLevel option") && (document.querySelector("#jobLevel option").innerHTML = "What is your job?...")
          document.querySelector("#Country option") && (document.querySelector("#Country option").innerHTML = "Country...")
          document.querySelector("[type='submit']") && (document.querySelector("[type='submit']").innerText = 'Get your free demo')
          ...
          helper.live('#Country','change',function(){
            ...
            helper.waitForElement('#State option',function(){
              document.querySelector('#numberofEmployeesstring').closest('.mktoFormRow').insertAdjacentElement('beforebegin', document.querySelector("#State").closest('.mktoFormRow'))
              document.querySelector("#State option").innerHTML = "State...";
              if (window.screen.width < 768){
                document.querySelector("#State option").innerHTML = "State";
              }
