(() => {
    try {
        ...
        const activate = () => {
            ...
            document.querySelector('.hero--copy .modal-video') && 
            document.querySelector('.hero--copy .modal-video').insertAdjacentHTML("afterbegin",playIcon);

            observeElement('.cta-module .button-primary.modal-video, .cta-container .button-primary[href*="player"]', ()=>{
                document.querySelector('.cta-module .button-primary.modal-video, .cta-container .button-primary[href*="player"]').insertAdjacentHTML("afterbegin",playIcon);
            });
        };
        ...
        console.log(e, 'Error in Box-313 v1')
    }
})();