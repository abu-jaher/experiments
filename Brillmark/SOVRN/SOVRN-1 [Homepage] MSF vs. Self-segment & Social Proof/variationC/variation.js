  ...
  try {
    ...
    var heroHtml = '' +
      ...
      '      <div class="fe-hero-cta container">' +
        '         <div class="row">' +
        '          <a href="https://www.sovrn.com/publishers/" class="col-md-3 fe-publishers"><button type="button">For Publishers</button></a>' +
        '          <a href="https://www.sovrn.com/advertisers/" class="col-md-3 fe-buyers"><button type="button">For Buyers</button></a>' +
        '      </div>'+
      '      </div>' +
      '     </div>' +
      '           </div>'+
    ...
    function init() {
      ...
      document.querySelector('.fe-publishers').addEventListener('click', function(){
        TrackGAEvent('Publishers_CTA_click', 'GA_Clicks', 'Publishers_CTA_clicks');
      });

      document.querySelector('.fe-buyers').addEventListener('click', function(){
        TrackGAEvent('Buyers_CTA_click', 'GA_Clicks', 'Buyers_CTA_click');
      });
