(function () {
  try {
    ...
    var heroHtml = '' +
      ...
      '         <h1 class="fe-main-heading">Earn more. Keep more.</h1>'+ 
      ...
      '  <div class="container">' +
      '  <div class="fe-testimonial-image">' +
      '   <img src="https://bm-test-dev.s3.us-east-2.amazonaws.com/FE/DICE/85/worldhistory.svg" alt="world-history">'+
      '   <img src="https://bm-test-dev.s3.us-east-2.amazonaws.com/FE/DICE/85/seprator.svg" alt="seprator">'+
      '  </div>'+
      '  <div class="fe-testimonial-text">' +
