(function () {
  try {
    ...
    function clickHandler() {
      const offsetTop = document.querySelector('.switcher-container.new-switcher').offsetTop - 100;
      console.log('hii')
      scroll({
        top: offsetTop,
        behavior: "smooth"
    ...
    function init() {
      ...
      live('.fetest1:not(.fepricing) [fe-btn="true"]:not(.fe-header):not(.test04)', 'click', function () {
        trackGAEvent('funnelenvy', 'click', 'Start Free Trial CTA clicks')
      });

      // click on demo cta click event
      live('.fetest1:not(.fepricing) [href^="https://www.uscreen.tv/request-demo/"]:not(.fe-header):not(.test04)', 'click', function () {
      ...
      if (pathname.indexOf('/pricing/') > -1) {
        ...
        live('.fetest1.fepricing .boxes-with-background-heading > .wp-block-group__inner-container >p+.wp-block-buttons .wp-block-button a[fe-btn="true"],.fetest1.fepricing .cta > .wp-block-group__inner-container >p+.wp-block-buttons .wp-block-button a[fe-btn="true"]', 'click', function (e) {
          e.preventDefault()
          clickHandler()
        })

      } else {
        _$('.fetest1 [href^="https://www.uscreen.io/join"]').attr('href', 'https://www.uscreen.tv/pricing/');
      }
